				...
				<td id="rightContent" valign="top">
					<div style="max-height:850px;overflow:auto;">
						<?php
							...
							if(!$db){
								...
								$query = "SELECT
										...
										FROM
											USERTABLE U
											LEFT OUTER JOIN USERFOLLOW UF
											ON (U.USERNAME = UF.USERTOFOLLOW AND UF.FOLLOWED = 1)
								...
								while($row = oci_fetch_array($statement, OCI_BOTH+OCI_RETURN_NULLS)){
									...
									$currentUserFirstName = $row[1];
									$currentUserLastName = $row[2];
									$currentUserAddress = $row[3];
									$currentUserPhoto = $row[4];
									if($row[5] != NULL)	{
										if($_SESSION['userName'] == $row[5]){
						...
						<table border="0" width="100%">
							...
							<tr>
								<td id="ProfilePic" width="20%" valign="top">
									<?php 
										$askerPhotoPath = "";
										if($currentUserPhoto == "1"){
											//Profile Photo
											$askerPhotoPath = "DP/".$currentUserName;
										} else {
											//Default Profile Photo
											$askerPhotoPath = "default_dp";
										}
									?>								
									<img src="../Images/<?php echo $askerPhotoPath; ?>.jpg" height="145" width="140"></img>									
								</td>
								<td id="OtherDetails" valign="top">
									<h2><?php echo $currentUserFirstName."	".$currentUserLastName ?></h2>									
									<h4><?php echo $currentUserAddress ?></h4>
									<p><?php echo count($followers); ?> others follow this user!</p>
								</td>
								<td id="FollowUser" width="20%" valign="top">
									<?php	
										$displayFollow = "inline";
										$alreadyFollow = "none";
										if($alreadyFollowing == true){
											$displayFollow = "none";
											$alreadyFollow = "inline";
										}else {
											$displayFollow = "inline";
											$alreadyFollow = "none";
										}
									?>
									<a href="Follow.php?userToFollow=<?php echo $currentUserName ?>&user=<?php echo $_SESSION['userName']; ?>&follow=1" style="float:right;display:<?php echo $displayFollow; ?>;">
										<img src="../Images/Follow_User.jpg" width="80%" style="float:right;display:<?php echo $displayFollow; ?>"></img>
									</a>
									<a href="Follow.php?userToFollow=<?php echo $currentUserName ?>&user=<?php echo $_SESSION['userName']; ?>&follow=0" style="float:right;display:<?php echo $alreadyFollow; ?>;">
										<img src="../Images/Unfollow.jpg" width="80%" style="float:right;display:<?php echo $alreadyFollow; ?>"></img>	
									</a>																											
								</td>
							</tr>	
							...
							<tr >
								<td colspan=3">
									...
									<hr/>
									<br/>									
									<label style="font-size:20;color:#000000;border-top-style:solid;">Questions asked by <?php echo $currentUserFirstName."	".$currentUserLastName ?></label>
									<br/>
									<?php
										$db = oci_connect("pdhar", "PunyabrataDhar", "oracle.cise.ufl.edu/orcl");
										//Connection Problem
										if(!$db){
											...
											$query = "SELECT
													...
													WHERE QAU.ASKUNAME = '".$userId."'".
													"ORDER BY QAU.QC DESC, QAU.Q#, QAU.UF, QAU.QUV, QAU.AC, QAU.A#, QAU.UV";
											$statement = oci_parse($db,$query);
									...
									<div style="max-height:500px;overflow:auto;">
										<p>
											<label><?php echo $currentUserFirstName."	".$currentUserLastName ?> asked <?php echo $quesCount; ?> question(s) so far</label>
										</p>
							...
							<tr >
								<td colspan=3">
									...
									<hr/>
									<br/>									
									<label style="font-size:20;color:#000000;border-top-style:solid;">Questions answered by <?php echo $currentUserFirstName."	".$currentUserLastName ?></label>
									<br/>
									<?php
										$db = oci_connect("pdhar", "PunyabrataDhar", "oracle.cise.ufl.edu/orcl");
										//Connection Problem
										if(!$db){
											...
											while($row = oci_fetch_array($statement, OCI_BOTH+OCI_RETURN_NULLS)){
												...
												if(strcmp($previousQN,$currentQN) == 0) {
													...
													//New Question
													$newQuestion = ($quesAnsCount > 0) ? true : false;
													$newQuesFollow = false;
													$newQuesVote = false;
													$newAnswer = false;
													$newAnswerVote = false;
									...
									<div style="max-height:500px;overflow:auto;">
										<p>
											<label><?php echo $currentUserFirstName."	".$currentUserLastName ?> answered <?php echo $quesAnsCount; ?> question(s) so far</label>
										</p>
										<table border="0" cellspacing="0" width="100%" id="questionAnswerTable">
											<?php foreach ($quesAnsArray as $eachQA) {
											?>
							...
							<tr >
								<td colspan=3">
									...
									<hr/>
									<br/>									
									<label style="font-size:20;color:#000000;border-top-style:solid;">Questions followed by <?php echo $currentUserFirstName."	".$currentUserLastName ?></label>
									<br/>
									<?php
										$db = oci_connect("pdhar", "PunyabrataDhar", "oracle.cise.ufl.edu/orcl");
										//Connection Problem
										if(!$db){
											...
											$query = "SELECT
													...
													WHERE QAU.UF = '".$userId."' AND QAU.F = 1".													
													"ORDER BY QAU.QC DESC, QAU.Q#, QAU.UF, QAU.QUV, QAU.AC, QAU.A#, QAU.UV";
											$statement = oci_parse($db,$query);
											//Executing the statement
											oci_execute($statement);
											...
											while($row = oci_fetch_array($statement, OCI_BOTH+OCI_RETURN_NULLS)){
												...
												if(strcmp($previousQN,$currentQN) == 0) {
													...
													//New Question
													$newQuestion = ($quesFollowCount > 0) ? true : false;
													$newQuesFollow = false;
													$newQuesVote = false;
													$newAnswer = false;
													$newAnswerVote = false;
									...
									<div style="max-height:500px;overflow:auto;">
										<p>
											<label><?php echo $currentUserFirstName."	".$currentUserLastName ?> followed <?php echo $quesFollowCount; ?> question(s) so far</label>
										</p>
										<table border="0" cellspacing="0" width="100%" id="questionAnswerTable">
											<?php foreach ($quesAnsArray as $eachQA) {
											?>
							...
							<tr >
								<td colspan=3">
									...
									<hr/>
									<br/>									
									<label style="font-size:20;color:#000000;border-top-style:solid;">Questions upvoted by <?php echo $currentUserFirstName."	".$currentUserLastName ?></label>
									<br/>
									<?php
										$db = oci_connect("pdhar", "PunyabrataDhar", "oracle.cise.ufl.edu/orcl");
										//Connection Problem
										if(!$db){
											...
											$query = "SELECT
													...
													WHERE QAU.QUV = '".$userId."' AND QAU.QV = 1".																					
													"ORDER BY QAU.QC DESC, QAU.Q#, QAU.UF, QAU.QUV, QAU.AC, QAU.A#, QAU.UV";
											$statement = oci_parse($db,$query);
											//Executing the statement
											oci_execute($statement);
											...
											while($row = oci_fetch_array($statement, OCI_BOTH+OCI_RETURN_NULLS)){
												...
												if(strcmp($previousQN,$currentQN) == 0) {
													...
													//New Question
													$newQuestion = ($quesUpVoteCount > 0) ? true : false;
													$newQuesFollow = false;
													$newQuesVote = false;
													$newAnswer = false;
													$newAnswerVote = false;
									...
									<div style="max-height:500px;overflow:auto;">
										<p>
											<label><?php echo $currentUserFirstName."	".$currentUserLastName ?> upvoted <?php echo $quesUpVoteCount; ?> question(s) so far</label>
										</p>
										<table border="0" cellspacing="0" width="100%" id="questionAnswerTable">
											<?php foreach ($quesAnsArray as $eachQA) {
											?>
							...
							<tr >
								<td colspan=3">
									...
									<hr/>
									<br/>									
									<label style="font-size:20;color:#000000;border-top-style:solid;">Questions downvoted by <?php echo $currentUserFirstName."	".$currentUserLastName ?></label>
									<br/>
									<?php
										$db = oci_connect("pdhar", "PunyabrataDhar", "oracle.cise.ufl.edu/orcl");
										//Connection Problem
										if(!$db){
											...
											while($row = oci_fetch_array($statement, OCI_BOTH+OCI_RETURN_NULLS)){
												...
												if(strcmp($previousQN,$currentQN) == 0) {
													...
													//New Question
													$newQuestion = ($quesDownVoteCount > 0) ? true : false;
													$newQuesFollow = false;
													$newQuesVote = false;
													$newAnswer = false;
													$newAnswerVote = false;
									...
									<div style="max-height:500px;overflow:auto;">
										<p>
											<label><?php echo $currentUserFirstName."	".$currentUserLastName ?> downvoted <?php echo $quesDownVoteCount; ?> question(s) so far</label>
										</p>
										<table border="0" cellspacing="0" width="100%" id="questionAnswerTable">
											<?php foreach ($quesAnsArray as $eachQA) {
											?>
