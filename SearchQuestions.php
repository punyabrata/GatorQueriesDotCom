	...
	global $count,$dbErrorDisplay ,$noQuestions,$str ;
		...
		if(isset($_POST['submitted'])){	
			...
			if(!$db){
				...
				$query = '';
				if($_POST['type']=='Tag'){
					$query = "SELECT distinct questionsubject, questiondescription FROM  Question, Questiontag WHERE question.question# = questiontag.question# and tagname like '%".$_POST['searchkey']."%'";
				}
				else{
					$query = "SELECT distinct questionsubject, questiondescription FROM  Question WHERE questionsubject like '%".$_POST['searchkey']."%'";
				}
				...
				<td id="rightContent" valign="top">
					...
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">	
						<table style="margin-left:auto;margin-right:auto;">
							...
							<tr>
								<td style="text-align:right;">Search Key</td>
								<td><input name="searchkey" type="text"/></td>
							</tr>
