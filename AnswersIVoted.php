	...
	global $count,$dbErrorDisplay ,$noQuestions,$str ;
		...
		if(true){	
			...
			if(!$db){
				...
				$query = "SELECT distinct questiondescription, answerdescription FROM  Question, Answer, answervote WHERE answervote.uservoted =  '".$_SESSION['userName']."' 
				and questionanswered = question# and answer.answer# = answervote.answer#";				
...
?>
	...
	<div id="tagcreated" style="border:2px solid #456789;border-top-color:#ABCDEF;width:80%;margin-left:auto;margin-right:auto;display:<?php echo $noQuestions; ?>">
		<h4 style="text-align:center;">
			There are no Answers Voted by you !
		</h4>
	</div>
