...
<?php	
	...
	if(isset($_POST['submitAnswer'])){
		...
		if(!$db){
			...
			$theAnswer = $_POST['answerField'];
			$query = "insert into Answer values((select floor(dbms_random.value*1000000000) from dual),'".$theAnswer."',".$_GET["id"].",'".$_SESSION['userName']."',(select sysdate from dual))";
			...
			<tr>
				...
				<td id="rightContent" valign="top">
					<div style="max-height:850px;overflow:auto;">
						...
						<form action="Question.php?id=<?php echo $quesId; ?>" method="post">
							<?php foreach ($quesAnsArray as $eachQuesAnsEntry) { ?>
							<table border="0" width="100%" style="border-bottom-style:solid;">
								<tr>
									<td id="ProfilePic" width="25%" valign="top">							
										<img src="../Images/Question.jpg" height="145" width="140"></img>									
									</td>
									<td id="OtherDetails" valign="top" colspan="2">
															
										<table border="0" width="100%">
											<tr>
												<td valign="top" width="20%">
													<img src="../Images/DP/<?php echo $eachQuesAnsEntry[0][0][1]; ?>.jpg" height="100" width="95"></img>
												</td>
												<td valign="top">
													<h3><?php echo $eachQuesAnsEntry[0][0][5]; ?></h3>
													<p style="font-size:18;"><?php echo $eachQuesAnsEntry[0][0][6]; ?></p>
													<p style="font-size:14;"><?php echo $eachQuesAnsEntry[0][0][7]; ?></p>
													<p>
														<table>
															<tr>
																<td>
																...
																<td>
																	<?php foreach ($eachQuesAnsEntry[0][1] as $eachTag) { ?>
										...
										<hr/>
										<table border="0" width="100%">
											<?php foreach ($eachQuesAnsEntry[1] as $eachAns) { ?>
											<tr>
												<td valign="top" width="20%">
													<img src="../Images/DP/<?php echo $eachAns[0][1]; ?>.jpg" height="100" width="95"></img>
												</td>
												<td valign="top">
													<p style="font-size:18;"><?php echo $eachAns[0][5]; ?></p>
													<p style="font-size:14;"><?php echo $eachAns[0][6]; ?></p>
												</td>
											</tr>
											<?php } ?>
										</table>										
										<table border="0" width="100%">
											<tr>
												<td valign="top">
													<textarea
													name="answerField"
													onFocus="if (value == 'Write an answer...') {value=''}" 
													onBlur="if (value== '') {value='Write an answer...'}" 
													value="Write an answer..." 
													style="width:100%;height:65;font-family:Tahoma;"
													></textarea>
												</td>
												<td valign="top" width="20%">
													<input type="submit" value="Post your answer" name="submitAnswer"/>
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									<td id="FollowUser" valign="top" style="padding-top:20;">
										<?php
											$displayFollow = "none";
											$alreadyFollow = "none";
											if(in_array($_SESSION['userName'], $eachQuesAnsEntry[0][2])){
									...
									<td id="FollowUser" valign="top" style="padding-top:20;">
										<a href="Follow.php?questionId=<?php echo $quesId; ?>&user=<?php echo $_SESSION['userName']; ?>&follow=1" style="float:right;display:<?php echo $displayFollow; ?>;">
											<img src="../Images/Follow_User.jpg" width="122" height="43" style="float:right;display:<?php echo $displayFollow; ?>;"></img>
										</a>
										<a href="Follow.php?questionId=<?php echo $quesId; ?>&user=<?php echo $_SESSION['userName']; ?>&follow=0" style="float:right;display:<?php echo $alreadyFollow; ?>;">
											<img src="../Images/Unfollow.jpg" width="122" height="43" style="float:right;display:<?php echo $alreadyFollow; ?>;"></img>	
										</a>
									</td>								
								</tr>
